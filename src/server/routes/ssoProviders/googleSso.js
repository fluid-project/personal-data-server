...
class GoogleSso {
     ...
     * the user's access.
     * @param {Object} ssoDbOps - Database access for storing the user, access token, and related records.
    ...
    async storeUserAndAccessToken(userInfo, accessTokenInfo, ssoDbOps, provider, preferences) {
        ...
        if (ssoUserAccountRecord === null) {
            ...
            ssoUserAccountRecord = await ssoDbOps.createSsoUserAccount(newUserRecord.user_account_id, userInfo, options.provider);
