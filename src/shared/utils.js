...
const loadConfig = function (configFile) {
    ...
    return {
        server: {
            ...
            selfDomain: process.env.PDS_DOMAIN || config.server.selfDomain,
            loginTokenRedirectUrl: process.env.PDS_LOGINTOKENREDIRECTURL || config.server.loginTokenRedirectUrl
        },
        db: {
